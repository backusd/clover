...
import { ModelData } from "./Scene.js";
...
`
        ...
        entries: [
            {
                ...
                buffer: {
                    ...
                    minBindingSize: ModelData.sizeInBytes
                }
            },
        ]
    });
    ...
    return new RenderPassLayer("rpl_basic-object", renderer, pipeline, null, undefined, renderItemBindGroupLayout, renderItemBindGroupLayoutGroupNumber);
}
