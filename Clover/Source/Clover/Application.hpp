...
namespace Clover
{
    ...
    public:
        ...
        http::message_generator HandleHTTPRequest(HTTPRequestType req);
    ...
    protected:
        ...
        inline void SetBadRequestTarget(std::string_view target) noexcept { m_badRequestTarget = target; }
        inline void SetNotFoundTarget(std::string_view target) noexcept { m_notFoundTarget = target; }
        inline void SetInternalServerErrorTarget(std::string_view target) noexcept { m_internalServerErrorTarget = target; }
    ...
    private:
        ...
        http::message_generator HandleHTTPPUTRequest(HTTPRequestType& req);
        http::message_generator HandleHTTPPOSTRequest(HTTPRequestType& req);

        http::message_generator BadRequest(std::string_view reason, HTTPRequestType& req);
        http::message_generator FileNotFound(std::string_view target, HTTPRequestType& req);
        http::message_generator InternalServerError(std::string_view reason, HTTPRequestType& req);
